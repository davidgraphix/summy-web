...
export const PopoverContent = React.forwardRef<
  React.ElementRef<typeof PopoverPrimitive.Content>, React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content>
  ...
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content ref={ref} align={align} sideOffset={sideOffset}
      className={cn(
        ...
        "data-[state=open]:animate-[content-in_120ms_ease-out]", className
      )} {...props} />
  </PopoverPrimitive.Portal>
));
